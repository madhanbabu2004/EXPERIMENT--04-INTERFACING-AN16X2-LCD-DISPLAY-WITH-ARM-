...
MX_GPIO_Init();
  Lcd_PortType ports[] = { GPIOA, GPIOA, GPIOA, GPIOA };
    ...
    Lcd_cursor(&lcd, 0,1);
    Lcd_string(&lcd, "MADHAN BABU P");
    Lcd_cursor(&lcd, 1,1);
    Lcd_string(&lcd, "212222230075");
while (1)
  {
}
}
...
## Output screen shots of proteus  :
 ...
 ![WhatsApp Image 2024-11-16 at 14 11 41_b59cbb2f](https://github.com/user-attachments/assets/0df5c717-acf6-45e1-abd5-86ad986808f3)

 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
 
 ![image](https://github.com/user-attachments/assets/21263c46-b967-4942-b98f-bb81df5fcab8)
